...
class DRTaskTrials(PropertyDict):
    ...
    def response_window_start_time(self) -> Sequence[float]:
        """Start of window in which the subject should lick if a GO trial,
    ...
    def response_window_stop_time(self) -> Sequence[float]:
        """End of window in which the subject should lick if a GO trial,
        otherwise should not lick."""
        return self.get_display_times(
    ...
    def post_response_window_start_time(self) -> Sequence[float]:
        """Start of null period in which the subject awaits a new trial or a
        timeout period; may receive a noncontingent reward if scheduled."""
    ...
    def timeout_start_time(self) -> Sequence[float]:
        """Start of extended inter-trial period added due to a false alarm."""
